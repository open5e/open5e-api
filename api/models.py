...
class Monster(GameContent):
    ...
    group = models.TextField(null=True, help_text='Used to group similar creatures at different stages. "Green Dragon"')
    ...
    armor_desc = models.TextField(null=True, help_text='Description of the armor or armor type.')
    hit_points = models.IntegerField(null=True, help_text='Integer of the hit points.')
    ...
    strength = models.IntegerField(null=True, help_text='Integer representing the strength score.')
    dexterity = models.IntegerField(null=True, help_text='Integer represeting the dexterity score.')
    constitution = models.IntegerField(null=True, help_text='Integer representing the constitution score.')
    intelligence = models.IntegerField(null=True, help_text='Integer representing the intelligence score.')
    wisdom = models.IntegerField(null=True, help_text='Integer representing the wisdom score.')
    charisma = models.IntegerField(null=True, help_text='Integer representing the charisma score.')
    strength_save = models.IntegerField(null=True, help_text='Integer representing the strength save.')
    dexterity_save = models.IntegerField(null=True, help_text='Integer representing the dexterity save.')
    constitution_save = models.IntegerField(null=True, help_text='Integer representing the constitution save.')
    intelligence_save = models.IntegerField(null=True, help_text='Integer representing the intelligence save')
    wisdom_save = models.IntegerField(null=True, help_text='Integer representing the wisdom save.')
    charisma_save = models.IntegerField(null=True, help_text='Integer representing the charisma save.')
    perception = models.IntegerField(null=True, help_text='Integer representing the passive perception score.')
    ...
    cr = models.FloatField(null=True, help_text='Monster challenge rating as a float.')
