# Generated by Django 3.2.20 on 2023-09-12 09:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ability_score_strength', models.IntegerField(default=0, help_text='Integer representing the strength ability.', validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(30)])),
                ('ability_score_dexterity', models.IntegerField(default=0, help_text='Integer representing the dexterity ability.', validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(30)])),
                ('ability_score_constitution', models.IntegerField(default=0, help_text='Integer representing the constitution ability.', validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(30)])),
                ('ability_score_intelligence', models.IntegerField(default=0, help_text='Integer representing the intelligence ability.', validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(30)])),
                ('ability_score_wisdom', models.IntegerField(default=0, help_text='Integer representing the wisdom ability.', validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(30)])),
                ('ability_score_charisma', models.IntegerField(default=0, help_text='Integer representing the charisma ability.', validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(30)])),
                ('saving_throw_strength', models.IntegerField(help_text='Signed integer added to strength saving throws.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('saving_throw_dexterity', models.IntegerField(help_text='Signed integer added to dexterity saving throws.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('saving_throw_constitution', models.IntegerField(help_text='Signed integer added to constitution saving throws.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('saving_throw_intelligence', models.IntegerField(help_text='Signed integer added to intelligence saving throws.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('saving_throw_wisdom', models.IntegerField(help_text='Signed integer added to wisdom saving throws.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('saving_throw_charisma', models.IntegerField(help_text='Signed integer added to charisma saving throws.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('skill_bonus_acrobatics', models.IntegerField(help_text='Signed integer added to acrobatics skill checks.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('skill_bonus_animal_handling', models.IntegerField(help_text='Signed integer added to animal handling skill checks.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('skill_bonus_arcana', models.IntegerField(help_text='Signed integer added to arcana skill checks.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('skill_bonus_athletics', models.IntegerField(help_text='Signed integer added to athletics skill checks.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('skill_bonus_deception', models.IntegerField(help_text='Signed integer added to deception skill checks.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('skill_bonus_history', models.IntegerField(help_text='Signed integer added to history skill checks.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('skill_bonus_insight', models.IntegerField(help_text='Signed integer added to insight skill checks.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('skill_bonus_intimidation', models.IntegerField(help_text='Signed integer added to intimidation skill checks.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('skill_bonus_investigation', models.IntegerField(help_text='Signed integer added to investigation skill checks.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('skill_bonus_medicine', models.IntegerField(help_text='Signed integer added to medicine skill checks.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('skill_bonus_nature', models.IntegerField(help_text='Signed integer added to nature skill checks.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('skill_bonus_perception', models.IntegerField(help_text='Signed integer added to perception skill checks.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('skill_bonus_performance', models.IntegerField(help_text='Signed integer added to performance skill checks.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('skill_bonus_persuasion', models.IntegerField(help_text='Signed integer added to persuasion skill checks.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('skill_bonus_religion', models.IntegerField(help_text='Signed integer added to religion skill checks.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('skill_bonus_sleight_of_hand', models.IntegerField(help_text='Signed integer added to sleight of hand skill checks.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('skill_bonus_stealth', models.IntegerField(help_text='Signed integer added to stealth skill checks.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('skill_bonus_survival', models.IntegerField(help_text='Signed integer added to survival skill checks.', null=True, validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(20)])),
                ('passive_perception', models.IntegerField(default=0, help_text='Integer representing the passive perception ability.', validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(30)])),
                ('key', models.CharField(help_text='Unique key for the Item.', max_length=100, primary_key=True, serialize=False)),
            ],
            options={
                'ordering': ['pk'],
